...
namespace varan {
    namespace gateway {
        ...
        struct FCanDetectionPayload {
            int count = 0;         // байт 1 — количество обнаружений по всем камерам
            int type = 0;          // байт 2 — тип обнаружения с наивысшей опасностью
            int danger = 0;        // байт 3 — класс опасности
            // Байт 4 — камеры битовой маской: бит на камеру, поэтому в одном
            // кадре видно сразу несколько камер, поймавших обнаружение.
            int camera_mask = 0;
        };
