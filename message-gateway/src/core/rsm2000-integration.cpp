...
namespace varan {
    namespace gateway {
        ...
        // принял хотя бы один модуль — это успех. Модуль отказывает только на
        // дефекте самого кадра (версия, кодирование); нет связи — он всё равно
        // принимает и пишет это себе в статистику.
