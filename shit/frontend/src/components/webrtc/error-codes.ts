 ...
 *   6xxx — слот нейронки (конфигурация, модель, контексты NPU, камера, стример)
 *
...
export type ErrorKind = 'transport' | 'session' | 'stream' | 'module' | 'config' | 'neural' | 'unknown';
...
const MESSAGES: Record<number, string> = {
    ...
    // 6xxx — слот нейронки
    6001: 'Конфигурация не найдена',
    6002: 'Файл модели не найден или не читается',
    6003: 'Модель не загрузилась в NPU',
    6004: 'Раскладка выходов модели не опознана',
    6005: 'Не создан ни один контекст NPU',
    6006: 'Камера не найдена в хранилище',
    6007: 'Стример потока не поднялся',
};
