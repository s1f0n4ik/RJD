      ...
      <div className="krsps-card">
        ...
        <div className="krsps-panel__body">
          <div className="krsps-note" style={{ marginBottom: 14 }}>
            ...
            сразу несколько камер, поймавших обнаружение. Имя камеры — справочное, из списка media-center;
            настраивается только бит. Изменения сохраняются сразу.
          </div>
              ...
              <span className="krsps-addline__note">
                {cameras.length >= 8
                  ...
                  : knownCameras.length === 0
                    ? 'Нет камер типа neural — media-center недоступен либо их нет'
                    : 'Все камеры типа neural уже добавлены'}
              </span>
            </div>
          )}
        </div>
